...
/**
 * Returns the time since initialization in milliseconds
 */
unsigned long millis(void);

/**
 * Timer initialization function.
 * Expanded to allow configuration of the reload value
 * Based off http://shukra.cedt.iisc.ernet.in/edwiki/EmSys:TM4C123_Timer_Programming
 * Page 710 of the datasheet states 80MHz clock (12.5 ns)
 * @param reload  systick overflow count
 */
void Timer_Time_Init(uint32_t reload);

/**
 * Timer handler, increments the counter every microsecond
 */
